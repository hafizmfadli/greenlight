...
// These new struct tags mean that only the Plaintext and Expiry fields will be included
// when encoding a Token struct — all the other fields will be omitted. We also rename the
// Plaintext field to "token" , just because it’s a more meaningful name for clients than
// ‘plaintext’ is.
