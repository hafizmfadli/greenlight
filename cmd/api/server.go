...
func (app *application) serve() error {
	...
	go func() {
		...
		// Shutdown() will return nil if the graceful shutdown was successfull, or an
		// error (which may happen because of problem closing the listeners, or because the shutdown
		// didn't complete before the 5-second context deadline is hit).
